...
----
dependencies {
    griffon '{project-group}:griffon-jcouchdb-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-jcouchdb-core:{project-version}'
}
----
...
----
dependencies {
    compileOnly '{project-group}:griffon-jcouchdb-groovy-compile:{project-version}'
}
----

== Maven

First configure the `griffon-jcouchdb-plugin` BOM in your POM file, by placing the following
